...
const Forms = () => {
  ...
  return (
    <div
      id="form"
      className="bg-LightBlue min-h-[730px] flex flex-col justify-center items-center pt-[65px]"
    >
      ...
      <form
        ...
        className="flex flex-col justify-center items-center gap-2 w-[210px] md:w-[310px] lg:w-[908px]"
      >
        <div className="flex max-[465px]:flex-col items-center justify-center gap-6 mb-8">
          <div className="flex flex-col items-center justify-center gap-8">
            <div className="flex flex-col gap-3 items-start">
              ...
              <Input
                className={`text-black w-[200px] md:w-[300px] lg:w-[440px] ${
            ...
            <div className="flex flex-col gap-3 items-start">
              ...
              <select
                className={`text-slate-500 p-2 ring-offset-background bg-background rounded w-[200px] md:w-[300px] lg:w-[440px] ${
                  errors.interest_plan ? "border-red-500 border-4" : ""
                }`}
          ...
          <div className="flex flex-col items-center justify-center gap-8">
            <div className="flex flex-col gap-3 items-start">
              ...
              <MaskedInput
                mask="(99) 99999-9999"
                className={`text-black w-[200px] md:w-[300px] lg:w-[440px] ${
                  errors.phone ? "border-red-500 border-4" : ""
                }`}
            ...
            <div className="flex flex-col gap-3 items-start">
              <Label className="text-white text-right">
                Segurado/Novo cliente
              </Label>
              <select
                className={`text-slate-500 p-2 ring-offset-background bg-background rounded w-[200px] md:w-[300px] lg:w-[440px] ${
                  errors.is_new_lead ? "border-red-500 border-4" : ""
                }`}
            ...
            <div className="flex flex-col gap-3 items-start">
              ...
              <select
                className={`text-slate-500 p-2 ring-offset-background bg-background rounded w-[200px] md:w-[300px] lg:w-[440px] ${
                  errors.is_pf ? "border-red-500 border-4" : ""
                }`}
                {...register("is_pf")}
        ...
        <div className="flex flex-col gap-3 items-start mb-6">
          ...
          <Textarea
            className={`text-black resize-none h-[150px] max-[465px]:w-[340px] w-[418px] md:w-[628px] lg:w-[908px] ${
              errors.demand ? "border-red-500 border-4" : ""
            }`}
        ...
        <Button
          className="bg-Yellow w-[241px] ml-auto rounded-full mb-5 max-[598px]:mb-5"
          type="submit"
          disabled={isPending}
        >
          {isPending ? (
